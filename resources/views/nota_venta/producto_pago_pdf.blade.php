           <div style="padding-left: 10px;padding-right: 10px;">
            ...
            <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
             <tbody>
              ...
              <td  align="right" style="color: grey;background-color: #def7e8;width: 250px;border-radius: 10px;text-align: center" >
        ...
        <tr><td style="background: #00000045;height:2px;margin:8px 0;padding: 0 10px" colspan="3"><span hidden="" style="color: #f9f9f900;font-size: 0px">{{$suma_hosting = $suma_hosting+$hosting_impresion->precio}}</span></td></tr>
      ...
      <tr><td style="background: #00000045;height:2px;margin:8px 0;" colspan="3"><span hidden=""  style="color: #f9f9f900;font-size: 0px">{{$suma_dominio = $suma_dominio+$dominio_impresion->precio}}</span></td></tr>
      @endforeach
      @endif
      {{--Fin Dominio  --}}
    ...
    <tr><td style="background: #00000045;height:2px;margin:8px 0;" colspan="3"><span hidden=""  style="color: #f9f9f900;font-size: 0px">{{$suma_certificado = $suma_certificado+$certificadossl_impresion->precio}}</span></td></tr>
    @endforeach
    @endif
    {{--Fin certificado SSl  --}}
