    ...
    <div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                ...
                <li><a href="{{route('usuario.index')}}"><img src="{{ asset('/multimedia/usuarios.svg')}}" class="iconos"><span class="nav-label">Usuarios</span> </a></li>
                ...
                <li class="">
                    ...
                    <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                        <li class="">
                            <a href="#" aria-expanded="false">Certificado<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level collapse" aria-expanded="false" style="height: 0px;">
                                <li><a href="{{route('plan_certicado_ssl.index')}}">Planes SSL</a></li>
                                <li><a href="{{route('certificado_ssl.index')}}">SSL</a></li>
                            </ul>
                        </li>
                        <li class="">
                            <a href="#" aria-expanded="false">Dominios<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level collapse" aria-expanded="false" style="height: 0px;">
                                <li><a href="{{route('proveedor_dominio.index')}}">Proveedor</a></li>
                                <li><a href="{{route('plan_dominio.index')}}">Planes Dominios</a></li>
                                <li><a href="{{route('dominios.index')}}">Dominios</a></li>
                            </ul>
                        </li>
                        <li class="">
                            <a href="#" aria-expanded="false">Hosting<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level collapse" aria-expanded="false" style="height: 0px;">
                                <li><a href="{{route('planes_hosting.index')}}">Planes Hosting</a></li>
                                <li><a href="{{route('hosting.index')}}">Hosting</a></li>
                            </ul>
                        </li>
                        <li class="">
                            <a href="#" aria-expanded="false">Licencias<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level collapse" aria-expanded="false" style="height: 0px;">
                                <li><a href="{{route('categoria.index')}}">Categorias</a></li>
                                <li><a href="{{route('licencia.index')}}">Licencias</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="#"><img src="{{ asset('/multimedia/soporte_tecnico.svg')}}" class="iconos"><span class="nav-label">Soporte Tecnico</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="{{route('plan_soporte_tecnico.index')}}">Planes Soporte</a></li>
                        <li><a href="{{route('soporte_tecnico.index')}}">Soporte Tecnico</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#"><img src="{{ asset('/multimedia/equipos.svg')}}" class="iconos"><span class="nav-label">Equipos</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="{{route('equipos.index')}}">Equipos</a></li>
                        <li><a href="{{route('tipo_equipo.index')}}">Tipo de Equipos</a></li>
                        <li><a href="{{route('marcas.index')}}">Marcas</a></li>
                    </ul>
                </li>

                <li><a href="{{route('nota_venta.index')}}"><img src="{{ asset('/multimedia/nota_venta.svg')}}" class="iconos"><span class="nav-label">Nota Ventas</span></a></li>
                <li><a href="{{route('empresa.index')}}"><img src="{{ asset('/multimedia/empresa.svg')}}" class="iconos"><span class="nav-label">Empresa</span></a></li>
